...
2. Place the required datasets under the `data/` folder.
3. Install the required Python packages.
4. Open `CVD_Q1_Final_GitHub_Master_Notebook.ipynb`.
...
For academic reproducibility code, common choices include MIT, BSD 3-Clause, and Apache 2.0.

The dataset licenses remain governed by their original providers and are separate from the code license.
